...
### Custom Palettes
If you want to use a different palette with `biscale` plots, you can use the new `bi_pal_custom()` function to create the plot and then apply it to `bi_scale_fill()` or `bi_scale_color()` using the `pal` argument.
