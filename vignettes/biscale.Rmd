...
```{r  final-map-rotated-legend, echo=FALSE, out.width = '100%'}
knitr::include_graphics("../man/figures/biscale.007.jpeg")
```
...
* If you have questions about using `biscale`, you are encouraged to use the [RStudio Community forums](https://forum.posit.co/). Please create a [`reprex`](https://reprex.tidyverse.org/) before posting. Feel free to tag Chris (`@chris.prener`) in any posts about `biscale`.
