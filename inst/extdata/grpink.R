...
# apply palette
data_DkViolet <- bi_pal(data, pal = "GrPink")
...
map <- ggplot() +
  ...
  labs(
    ...
    subtitle = "Dark Gray Pink (GrPink) Palette"
  ) +
  bi_theme()


# separate the groups used for plotting
bs <- bi_legend(pal = "GrPink")
...
ggsave(filename = "inst/extdata/grpink.png", height = 12.54, width = 8.505, dpi = 500)
