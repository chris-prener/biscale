...
This approach allows us to customize legend's placement and size to suit different map layouts. All of the maps shown as part of this vignette were produced using this approach. *As of June 21, this workflow has been tested with the new [release candidate for `cowplot`](https://github.com/wilkelab/cowplot) and works as expected.*
