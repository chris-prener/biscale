...
`biscale` has the `sf` package as a suggested dependency, which may require additional work install. You should check the [`sf` package website](https://r-spatial.github.io/sf/) for the latest details on installing that package if you do not already have it installed. Instructions vary significantly by operating system.
