...
Note that, as of v0.2 of the `biscale` package, `sf` is imported when you load `biscale`. This resolves issues related to not loading `sf` ahead of time, though it does add a dependency that a small number of users may have wished not to install.
